...
CREATE TABLE `clients` (
    ...
    `token_endpoint` VARCHAR(50) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `change_password` ADD CONSTRAINT `change_password_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `users`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `verify_emails` ADD CONSTRAINT `verify_emails_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `users`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `tokens` ADD CONSTRAINT `tokens_client_id_fkey` FOREIGN KEY (`client_id`) REFERENCES `clients`(`id_client`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `logs` ADD CONSTRAINT `logs_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `logs` ADD CONSTRAINT `logs_client_id_fkey` FOREIGN KEY (`client_id`) REFERENCES `clients`(`id_client`) ON DELETE RESTRICT ON UPDATE CASCADE;
